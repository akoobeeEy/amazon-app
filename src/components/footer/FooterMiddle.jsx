...
import { middleList } from "../../constants/allData";
    ...
    <div className="w-full bg-amazon_light text-white">
      ...
      <div className="w-full border-b-[1px] border-gray-500 p-10">
        <div className="max-w-5xl mx-auto text-gray-300">
          <div className="w-full grid grid-cols-1  md:grid-cols-2 lgl:grid-cols-4  gap-6  md:items-start md:place-items-center">
            {middleList.map((item) => (
              <FooterMiddleList
                key={item._id}
                title={item.title}
